...
<h1 style="color: #17bebb;text-align:center;margin-bottom: 20px;margin-top: 150px;">Psychiatre</h1> 
<div class="container">
<div class="input-group">
        <input class="form-control" id="myInput" type="text" placeholder="Chercher un psychiatre...">
  <br> 
</div>
</div>
