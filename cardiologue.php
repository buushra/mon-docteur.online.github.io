...
<head>
    ...
    <title>Cardiologue</title>

</head>
<body style="background-color: #e3e3e3;">
<h1 style="color: #17bebb;text-align:center;margin-bottom: 20px;margin-top: 150px;">Neurologue</h1> 
<div class="container">
<div class="input-group">
      <input class="form-control" id="myInput" type="text" placeholder="Chercher un cardiologue...">
  <br> 
</div>
</div>
        ...
        <table class='table table-striped'>
            ...
            <tbody>
                ...
                while ($data = mysql_fetch_array($res)){
                    ...
                    echo"<th>" .$data['idc']. "&nbsp&nbsp&nbsp&nbsp" .$data['nom']; 
                    echo "<th>";
                    echo "<th>";
                    echo"<th>";
                    echo "<tr style='background-color: white;border:white;color: #17bebb;'>";
