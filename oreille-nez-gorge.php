...
<head>
    ...
    <title>Oreille-Nez-Gorge</title>

</head>
<body style="background-color: #e3e3e3;">
<h1 style="color: #17bebb;text-align:center;margin-bottom: 20px;margin-top: 150px;">Oreille-Nez-Gorge</h1> 
<div class="container">
<div class="input-group">
   
      <input class="form-control" id="myInput" type="text" placeholder="Chercher un ORL...">
  <br> 
</div>
</div>
...
$r="select*from oreille-nez-gorge";
