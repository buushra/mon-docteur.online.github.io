...
<head>
    ...
    <title>Gastroentérologue </title>

</head>
<body style="background-color: #e3e3e3;">
<h1 style="color: #17bebb;text-align:center;margin-bottom: 20px;margin-top: 150px;">Gastroentérologue</h1> 
<div class="container">

    
      <input class="form-control" id="myInput" type="text" placeholder="Chercher un gastrologue...">
  <br> 
        ...
        <table class='table table-striped'>
            ...
            <tbody id='myTable'>
                ...
                while ($data = mysql_fetch_array($res)){
                    ...
                    echo"<th>" .$data['idg']. "&nbsp&nbsp&nbsp&nbsp" .$data['nom']; 
                    echo "<th>";
                    echo "<th>";
                    echo"<th>";
                    echo "<tr style='background-color: white;border:white;color: #17bebb;'>";
