...
<h1 style="color: #17bebb;text-align:center;margin-bottom: 20px;margin-top: 150px;">Vétérinaire</h1> 
<div class="container">

    
      <input class="form-control" id="myInput" type="text" placeholder="Chercher un vétérinaire...">
  <br> 
        ...
        <table class='table table-striped'>
            ...
            <tbody id='myTable'>
                ...
                while ($data = mysql_fetch_array($res)){
                    ...
                    echo"<th>" .$data['idv']. "&nbsp&nbsp&nbsp&nbsp" .$data['nom']; 
                    echo "<th>";
                    echo "<th>";
                    echo"<th>";
                    echo "<tr style='background-color: white;border:white;color: #17bebb;'>";
