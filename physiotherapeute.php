...
<head>
    ...
    <title>Physiothérapeute </title>

</head>
<body style="background-color: #e3e3e3;">
<h1 style="color: #17bebb;text-align:center;margin-bottom: 20px;margin-top: 150px;">Physiothérapeute</h1> 
<div class="container">

    
      <input class="form-control" id="myInput" type="text" placeholder="Chercher un physiothérapeute...">
  <br> 
...
$r="SELECT * FROM physiotherapeute"; 
